...
Erinnerst du dich: Ich hatte erwähnt, dass die Ausgabe der App-Komponente HTML ähnelt. Diese Abwandlung heißt JSX und mischt HTML und JavaScript. Mal sehen, wie das für die Anzeige der Variablen genau funktioniert:
...
* Lese mehr zum Thema [React's JSX](https://reactjs.org/docs/introducing-jsx.html).
